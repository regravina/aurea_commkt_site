    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Nossos Cursos</h3>
      ...
      {/* E-books Imersão em IA */}
      <section className="py-12 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">E-books: Série Imersão em IA</h3>
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            {ebooksImersaoIA.map((ebook) => (
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Outros E-books</h3>
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            {outrosEbooks.map((ebook) => (
              <div key={ebook.id} className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-lg transition relative">
      ...
      <footer className="bg-gray-900 text-white py-12 mt-20 text-center">
        <p className="text-gray-500">&copy; {new Date().getFullYear()} AUREA Comunicação & Marketing. Todos os direitos reservados.</p>
      </footer>
    </div>
  );
}
